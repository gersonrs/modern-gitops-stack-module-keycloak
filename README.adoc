...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret_v1[kubernetes_secret_v1.keycloak_db_secret] (resource)
...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/secret_v1[kubernetes_secret_v1.admin_credentials] (data source)
...
==== [[input_enable_custom_theme]] <<input_enable_custom_theme,enable_custom_theme>>
...
==== [[input_theme_config]] <<input_theme_config,theme_config>>
